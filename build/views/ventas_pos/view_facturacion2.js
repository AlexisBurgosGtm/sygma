...
function getView(){
    ...
    let view = {
        body:()=>{
            return `
                <div class="pos2-wrap">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-md-5 col-7">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="negrita mb-0 pos2-bar-title" style="font-size:0.95rem" id="lbFac2Titulo">Facturación</div>
                                        <div class="small" style="opacity:0.9" id="lbFac2Resumen">0 documentos</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7 col-5 text-right">
                                <div class="small mb-0" style="opacity:0.85" id="lbFac2BarLabel">Total del día</div>
                                <div class="negrita pos2-total-main" id="lbFac2TotalBar">Q 0.00</div>
                                <div class="d-none" id="fac2BarIngreso">
                                    <div class="small" id="lbTotalItems">0 items</div>
                                    <div class="d-none" id="lbTotalVenta">Q 0.00</div>
                                    <div class="d-none" id="lbTotalDescuento">Q 0.00</div>
                    ...
                    <div id="fac2Listado">
                        <div class="pos2-panel-card mx-2 mt-2">
                            <div class="pos2-panel-head d-flex justify-content-between align-items-center flex-wrap">
                                <span class="negrita mb-0"><i class="fal fa-file-invoice mr-1"></i> Facturas registradas (FAC)</span>
                            </div>
                            <div class="card-body">
                                <div class="compras2-listado-filtros mb-3">
                                    <input type="date" class="form-control negrita compras2-listado-filtros__fecha" id="txtFac2Fecha" title="Fecha">
                                    <select class="form-control negrita compras2-listado-filtros__coddoc" id="cmbFac2CoddocNuevo" title="Serie del documento a crear"></select>
                                    <input type="search" class="form-control negrita compras2-listado-filtros__buscar" id="txtFac2Buscar" placeholder="Buscar documento, cliente, hora..." autocomplete="off">
                                </div>
                                <div class="pos2-table-scroll table-responsive">
                                    <table class="table table-sm table-hover table-bordered mb-0" id="tblFac2">
                                        <thead class="bg-base text-white"><tr><th>HORA</th><th>DOCUMENTO</th><th>CLIENTE</th><th class="text-right">IMPORTE</th><th class="text-center">ST</th><th class="text-center">PAGO</th><th class="text-center">OPCIONES</th></tr></thead>
                                        <tbody id="tblDataFac2"><tr><td colspan="7" class="text-center text-muted py-4">Cargando...</td></tr></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="fac2Ingreso" class="d-none">
                        <div id="fac2IngresoLoader" class="compras2-ingreso-loader d-none" aria-live="polite" aria-busy="true" aria-hidden="true">
                            <div class="compras2-ingreso-loader__panel" id="fac2IngresoLoaderInner"></div>
                        </div>
                        <div class="px-2 pt-2 pb-1 d-flex align-items-center flex-wrap">
                            <button type="button" class="btn btn-outline-secondary btn-sm hand shadow-sm" id="btnFac2VolverListado">
                                <i class="fal fa-arrow-left mr-1"></i> Volver al listado
                            </button>
                            <span class="small negrita text-danger ml-auto" id="lbFac2DocRef"></span>
                        </div>

                    <div id="pos2EditBanner" class="pos2-edit-banner d-none">
                    ...
                    <button type="button" class="btn btn-success btn-xl btn-circle shadow hand sygma-fab-nuevo oculto-impresion" id="btnFac2Nuevo" title="Nueva factura">
                        <i class="fal fa-plus"></i>
                    </button>
                    <div id="fac2_print_host" class="sygma-embarque-print-host" aria-hidden="true"></div>
                </div>
            `
        },
        pedido:()=>{
                    ...
                    <div class="pos2-sidebar">
                        ...
                        <div class="pos2-sidebar-save">
                            <div class="text-center mb-1">
                                ...
                                <div class="pos2-sidebar-total-value text-danger" id="lbPosCobroTotalPagar">Q 0.00</div>
                            </div>
            ...
            <button type="button" class="btn btn-base btn-xl btn-bottom-l btn-circle shadow hand d-none" id="btnListadoDocumentos" title="Documentos del día">
        ...
        modal_lista_precios:()=>{
            return `
            <div class="modal fade sygma-doc-detalle-modal sygma-embarque-select-modal fac2-modal-productos" id="modal_pos2_lista_precios" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-content sygma-doc-detalle-modal__content">
                        <div class="sygma-doc-detalle-modal__header sygma-embarque-select-modal__header">
                            <div class="sygma-doc-detalle-modal__header-top mb-0">
                                <div>
                                    ...
                                    <p class="sygma-doc-detalle-modal__doc-ref mb-0">Seleccione un producto para agregar a la factura</p>
                                </div>
                        ...
                        <div class="modal-body sygma-embarque-select-modal__body">
                            <div class="sygma-embarque-rpt__toolbar">
                                <input type="text" autocomplete="off" class="form-control sygma-embarque-rpt__search" placeholder="Filtrar resultados..." id="txtBusquedaProducto" oninput="F.crearBusquedaTabla('tblProductos','txtBusquedaProducto')">
                            </div>
        ...
        modal_cantidad:()=>{
            return `
            <div class="modal fade sygma-doc-detalle-modal compras2-modal-cantidad pos2-modal-cantidad" id="modal_pos2_cantidad" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content sygma-doc-detalle-modal__content">
        ...
        modal_editar_cantidad:()=>{
            return `
            <div class="modal fade sygma-doc-detalle-modal compras2-modal-cantidad pos2-modal-cantidad" id="modal_pos2_editar_cantidad" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content sygma-doc-detalle-modal__content">
                        <div class="sygma-doc-detalle-modal__header compras2-modal-cantidad__header">
                            <div class="sygma-doc-detalle-modal__header-top mb-0">
        ...
        modal_lista_clientes:()=>{
            return `
            <div class="modal fade sygma-doc-detalle-modal sygma-embarque-select-modal fac2-modal-clientes" id="modal_pos2_lista_clientes" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                    <div class="modal-content sygma-doc-detalle-modal__content">
                        <div class="sygma-doc-detalle-modal__header sygma-embarque-select-modal__header">
                            <div class="sygma-doc-detalle-modal__header-top mb-0">
                                <div>
                                    <h4 class="sygma-doc-detalle-modal__title">Buscar cliente</h4>
                                    <p class="sygma-doc-detalle-modal__doc-ref mb-0">Seleccione un cliente para la factura</p>
                                </div>
                                <button type="button" class="sygma-doc-detalle-modal__close" data-dismiss="modal" aria-label="Cerrar">
                                    <i class="fal fa-times"></i>
                                </button>
                        ...
                        <div class="modal-body sygma-embarque-select-modal__body">
                            <div class="sygma-embarque-rpt__toolbar">
                                <div class="input-group">
                                    <input type="search" autocomplete="off" class="form-control sygma-embarque-rpt__search border-base negrita" id="txtBuscarClie" placeholder="NIT, código o nombre...">
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-base hand" id="btnBuscarClie"><i class="fal fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive sygma-embarque-rpt__table-wrap sygma-embarque-select-modal__table-wrap mt-2">
                                <table class="table sygma-embarque-rpt__table mb-0" id="tblClientesFac2">
                                    <thead>
                                        <tr>
                                            <th>NIT / CÓDIGO</th>
                                            <th>CLIENTE</th>
...
function addListeners(){
    ...
    const txtFecha = document.getElementById('txtFac2Fecha');
    if (txtFecha) {
    ...
    document.getElementById('txtFac2Buscar')?.addEventListener('input', () => {
        F.crearBusquedaTabla('tblFac2', 'txtFac2Buscar');
    });

    document.getElementById('btnFac2Nuevo')?.addEventListener('click', () => {
        if (typeof fac2_iniciar_nuevo === 'function') fac2_iniciar_nuevo();
    });

    if (typeof fac2_cargar_select_coddoc_nuevo === 'function') {
        fac2_cargar_select_coddoc_nuevo();
    }

    if (typeof fac2_show_listado === 'function') {
        fac2_show_listado();
    }
...
function destroyView() {
    ...
    document.body.classList.remove('modal-open', 'fac2-en-ingreso');
    ...
    if (typeof fac2_reset_modal_bindings === 'function') fac2_reset_modal_bindings();
    fac2_ingresoListenersReady = false;
    Pos2ModoEdicion = { activo: false, coddoc: '', correlativo: '' };
...
function initView(){
    fac2_ingresoListenersReady = false;
    document.body.classList.remove('fac2-en-ingreso');
    if (typeof fac2_reset_sesion === 'function') fac2_reset_sesion();
    Pos2ModoEdicion = { activo: false, coddoc: '', correlativo: '' };
    Pos2ProductosBusqueda = [];
    getView();
...
function insert_producto_pedido(codprod,desprod,desprod2,codmedida,equivale,costo,precio,cantidad,exento,tipoprod,tipoprecio,existencia,bono,descuento){
    ...
    // EXISTENCIA cruda en unidades base (facturación)
