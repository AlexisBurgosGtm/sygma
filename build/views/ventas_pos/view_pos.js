                ...
                <div class="col-sm-12 col-md-6 col-lg-8 col-xl-8">
                    <div class="card card-rounded shadow col-12 border-base">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="text-secondary">Vehiculo</label>
                                    <select class="form-control negrita" id="cmbVehiculo">
                                    </select>
                                </div>
                            </div>
...
function get_buscar_producto(filtro){
    ...
    document.getElementById('tblDataProductos').value = '';
...
function insert_producto_pedido(codprod,desprod,desprod2,codmedida,equivale,costo,precio,cantidad,exento,tipoprod,tipoprecio,existencia,bono,descuento){
    ...
    // EXISTENCIA cruda en unidades base (POS)
