                    ...
                    <div class="card border-base card-rounded shadow col-11 p-2">
                            ...
                            <div class="row">
                                <div class="col-4 text-left">   
                                    <label class="text-verde negrita h5" style="font-size:120%">Orden de Compra</label>
                                    <br>
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control col-12" id="cmbTipoDocumento">
                                                <option value="ORC">ORDEN DE COMPRA</option>
                                            </select>   
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control text-base negrita" id="txtSerieFac" placeholder="Serie Factura" disabled="true">
                                        <input type="text" class="form-control text-base negrita" id="txtNumeroFac" placeholder="Número Factura" disabled="true">
                                    </div>
                                </div>        
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control negrita" id="cmbTipoDoc">
                                                <option value="ORC">ORDENES DE COMPRA</option>
            ...
            <div class="modal fade"  id="modal_tomar_datos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-4">
                            <div class="form-group">
                                <label class="negrita text-base">Escriba para buscar..</label>
                                <input type="search" class="form-control negrita text-base" oninput="F.crearBusquedaTabla('tblTomarDatos','txtBuscarTomarDatos')" id="txtBuscarTomarDatos">
                            </div>
    ...
    .then((data)=>{
        ...
        data.recordset.map((r)=>{
            ...
            <tr>
                ...
                <td>${r.NOMBRE}
                    <br>
                    <small class="col-12 text-center negrita text-white ${F.get_color_prioridad(r.ETIQUETA)}">Prioridad: ${r.ETIQUETA}</small>
                </td>
                <td>${r.OBS}</td>
                <td class="negrita text-base">${F.setMoneda(r.IMPORTE,'Q')}</td>
                <td>
                ...
                <td>
                    <button class="btn btn-md btn-base btn-circle hand shadow" id="${idbtn}"
...
function get_documento_tomar_datos(coddoc,correlativo,codigoprov,nit,nombre,direccion,prioridad,obs,idBtn){
    ...
    F.Confirmacion('¿Está seguro que desea Cargar este Documento?')
    .then((value)=>{
        if(value==true){
            ...
            .then(()=>{
                ...
                .catch((error)=>{
                    ...
                    F.showToast("No se cargó el documento...");
