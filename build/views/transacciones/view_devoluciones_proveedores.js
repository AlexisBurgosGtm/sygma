                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-md-6 col-7">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="negrita mb-0 pos2-bar-title" style="font-size:0.95rem">Notas de credito a Proveedores</div>
...
function addListeners(){
    ...
    document.title = 'Notas de credito a Proveedores';
...
function get_coddoc(){
    ...
    GF.get_data_tipodoc_coddoc_sucursal(sucursal,'DVP')
    .then((data)=>{
...
function get_listado_factura(){
    ...
    GF.get_data_documentos_fechas(sucursal,'COM',fi,ff)
    .then((data)=>{
        let str ='';
        data.recordset.map((r)=>{
            str+= `
