...
function addListeners(){
    ...
    let btnIniciarCheckIn = document.getElementById('btnIniciarCheckIn');
    let btnFinalizarCheckIn = document.getElementById('btnFinalizarCheckIn');


    btnIniciarCheckIn.style = 'visibility:hidden';
    btnFinalizarCheckIn.style = 'visibility:hidden';


    F.showToastNew('Verificando Check In...');

    db_checkin.verify(GlobalCodUsuario, F.getFecha())
    .then((data)=>{
        ...
        if(finalizado=='NO'){
            btnFinalizarCheckIn.style = 'visibility:visible';
        }else{ 
            btnFinalizarCheckIn.style = 'visibility:hidden';
        }
    })
    .catch((err)=>{
        btnIniciarCheckIn.style = 'visibility:visible';
        btnFinalizarCheckIn.style = 'visibility:hidden';
    })
    ...
    */
    ...
    btnIniciarCheckIn.addEventListener('click',()=>{
            ...
            btnIniciarCheckIn.disabled = true;
            btnIniciarCheckIn.innerHTML = `<i class="fal fa-street-view fa-spin"></i>`;
            ...
            .then((res)=>{
                ...
                btnIniciarCheckIn.disabled = false;
                btnIniciarCheckIn.innerHTML = `<i class="fal fa-street-view"></i>`;

                btnIniciarCheckIn.style = 'visibility:hidden';
                btnFinalizarCheckIn.style = 'visibility:visible';
                
                let datos_checkin = {CODEMP:Number(GlobalCodUsuario),FECHA:F.getFecha().toString(),HINICIO:F.getHora(),HFIN:'NO'};
                db_checkin.insert(datos_checkin)
                .then(()=>{
    ...
    btnFinalizarCheckIn.addEventListener('click',()=>{
        ...
        .then((value)=>{
            if(value==true){
                    ...
                    btnFinalizarCheckIn.disabled = true;
                    btnFinalizarCheckIn.innerHTML = `<i class="fal fa-upload fa-spin"></i>`;
                    ...
                    .then((res)=>{
                        ...
                        btnFinalizarCheckIn.disabled = false;
                        btnFinalizarCheckIn.innerHTML = `<i class="fal fa-upload"></i>`;

                        btnFinalizarCheckIn.style = 'visibility:hidden';

                        db_checkin.finalizar(GlobalCodUsuario,F.getFecha().toString())
                        .then(()=>{
                            console.log('Checkin finalizado successfully');
                        })
                        .catch((err)=>{
                            console.error('Error finalizando checkin:', err);
                        })
