function getView(){
    let view = {
        ...
        modal_ofertas_pedido:()=>{
            return `
            <div class="modal fade ped-modal-detalle ped-modal-detalle--wide ped-modal-detalle--tall" id="modal_ofertas_pedido" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        modal_visita:()=>{
            return `
            <div class="modal fade ped-modal-detalle" tabindex="-1" role="dialog" aria-hidden="true" id="modal_visita">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="ped-modal-detalle__header">
                            <div>
                                <h5 class="negrita mb-0">Registrar visita</h5>
                                <small class="text-muted">Motivo por el que no se vendió</small>
                            </div>
                        ...
                        <div class="modal-body ped-modal-detalle__body">
                            <div class="ped-modal-detalle__cliente">
                                <div class="negrita text-base" id="lbNegocioclieVisita"></div>
                                <div class="negrita" id="lbNomclieVisita"></div>
                                <small class="text-muted">Código: <span id="lbCodclieVisita"></span></small>
                            </div>
                            <div class="form-group mb-0">
                                <label class="small text-muted mb-1">Motivo</label>
                                <select class="form-control negrita" id="cmbMotivoNoVisita">
                                    <option value='NO DINERO'>NO DINERO</option>
                                    <option value='NEGOCIO CERRADO'>NEGOCIO CERRADO</option>
                                    <option value='NO ESTA EL ENCARGADO'>NO ESTA EL ENCARGADO</option>
                                    <option value='TIENE PRODUCTO'>TIENE PRODUCTO</option>
                        ...
                        <div class="ped-modal-detalle__footer">
                            <button type="button" class="btn btn-light hand" data-dismiss="modal">Cancelar</button>
                            <button type="button" class="btn btn-info hand negrita" id="btnGuardarVisita">
                                <i class="fal fa-paper-plane mr-1"></i>Registrar
                            </button>
                        </div>
                    </div>
                </div>
        ...
        modal_historial_cliente:()=>{
            return `
            <div class="modal fade ped-modal-detalle ped-modal-detalle--wide ped-modal-detalle--tall" tabindex="-1" role="dialog" aria-hidden="true" id="modal_historial_cliente">
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="ped-modal-detalle__header">
                            <div>
                                <h5 class="negrita mb-0">Historial de compras</h5>
                                <small class="text-muted d-block" id="lbNomclieHistorial"></small>
                                <small class="text-muted"><span id="lbNegocioclieHistorial"></span> · <span id="lbCodclieHistorial"></span></small>
                            </div>
                            <button type="button" class="btn btn-sm btn-circle ped-modal-detalle__close hand" data-dismiss="modal" aria-label="Cerrar">
                                <i class="fal fa-times"></i>
                            </button>
                        ...
                        <div class="modal-body ped-modal-detalle__body">
                            <div class="form-row mb-2">
                                <div class="col-6">
                                    ...
                                    <select class="form-control form-control-sm" id="cmbMesHistorial"></select>
                                </div>
                                <div class="col-6">
                                    <label class="small text-muted mb-1">Año</label>
                                    <select class="form-control form-control-sm" id="cmbAnioHistorial"></select>
                                </div>
                            </div>
                            <div class="table-responsive ped-modal-table-wrap">
        ...
        modal_marcas_cliente:()=>{
            return `
            <div class="modal fade ped-modal-detalle ped-modal-detalle--tall" tabindex="-1" role="dialog" aria-hidden="true" id="modal_marcas_cliente">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="ped-modal-detalle__header">
                            <div>
                                <h5 class="negrita mb-0">Marcas del mes</h5>
                                <small class="text-muted d-block" id="lbNomclieMarca"></small>
                                <small class="text-muted">Código: <span id="lbCodclieMarca"></span></small>
                            </div>
                            <button type="button" class="btn btn-sm btn-circle ped-modal-detalle__close hand" data-dismiss="modal" aria-label="Cerrar">
                                <i class="fal fa-times"></i>
                            </button>
                        ...
                        <div class="modal-body ped-modal-detalle__body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <small class="text-muted mb-0">Compras del mes en curso</small>
                                <span class="negrita text-danger" id="lbTotalClienteMarca">--</span>
                            </div>
                            <div class="table-responsive ped-modal-table-wrap">
                                <table class="table table-sm table-hover ped-modal-table">
                                    <thead>
                                        <tr>
                                            <td>MARCA</td>
                                            <td class="text-right">TOTAL VENDIDO</td>
                                        </tr>
                                    </thead>
                                    <tbody id="tbl_data_marcas_cliente"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade ped-modal-detalle ped-modal-detalle--wide ped-modal-detalle--tall" tabindex="-1" role="dialog" aria-hidden="true" id="modal_goles">
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="ped-modal-detalle__header">
                            <div>
                                <h5 class="negrita mb-0">Goles P&G del mes</h5>
                                <small class="text-muted d-block" id="lbNomclieVisitaGoles"></small>
                                <small class="text-muted" id="lbNegocioclieVisitaGoles"></small>
                            </div>
                            <button type="button" class="btn btn-sm btn-circle ped-modal-detalle__close hand" data-dismiss="modal" aria-label="Cerrar"
                        ...
                        <div class="modal-body ped-modal-detalle__body">
                            ...
                            <div class="table-responsive ped-modal-table-wrap">
                                <table class="table table-sm table-hover ped-modal-table" id="tblGoles">
                                    <thead>
                                        <tr>
                                            <td>PRODUCTO</td>
                                            <td class="text-right">UNS. VENDIDAS</td>
                                            <td class="text-right">IMPORTE</td>
                                        </tr>
                                    </thead>
        ...
        modal_solicitud_cambio_cliente: () => `
            <div class="modal fade ped-modal-detalle ped-modal-detalle--tall" tabindex="-1" role="dialog" aria-hidden="true" id="modal_solicitud_cambio_cliente">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="ped-modal-detalle__header">
                            <div>
                                <h5 class="negrita mb-0">Solicitar cambios</h5>
                                <small class="text-muted">Actualice los datos del cliente</small>
                            </div>
                            <button type="button" class="btn btn-sm btn-circle ped-modal-detalle__close hand" data-dismiss="modal" aria-label="Cerrar">
                                <i class="fal fa-times"></i>
                            </button>
                        ...
                        <div class="modal-body ped-modal-detalle__body">
                            ...
                            <div class="form-group mb-2">
                                <label class="small text-muted mb-1">NIT</label>
                                <input type="text" class="form-control form-control-sm negrita" id="txtSolCambioNit">
                            </div>
                            <div class="form-group mb-2">
                                <label class="small text-muted mb-1">Nombre</label>
                                <input type="text" class="form-control form-control-sm negrita" id="txtSolCambioNombre">
                            </div>
                            <div class="form-group mb-2">
                                <label class="small text-muted mb-1">Negocio</label>
                                <input type="text" class="form-control form-control-sm negrita" id="txtSolCambioNegocio">
                            </div>
                            <div class="form-group mb-2">
                                <label class="small text-muted mb-1">Dirección</label>
                                <input type="text" class="form-control form-control-sm negrita" id="txtSolCambioDireccion">
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-row">
                                <div class="form-group col-6 mb-0">
                                    ...
                                    <select class="form-control form-control-sm negrita" id="cmbSolCambioDepartamento"></select>
                                </div>
                                <div class="form-group col-6 mb-0">
                                    <label class="small text-muted mb-1">Municipio</label>
                                    <select class="form-control form-control-sm negrita" id="cmbSolCambioMunicipio"></select>
                                </div>
                            </div>
                        </div>
                        <div class="ped-modal-detalle__footer">
                            <button type="button" class="btn btn-light hand" data-dismiss="modal">Cancelar</button>
                            <button type="button" class="btn btn-info hand negrita" id="btnEnviarSolicitudCambioCliente">
...
function addListeners(){
    ...
    const btnOfertas = document.getElementById('btnOfertasDisponiblesPedido');
    if (btnOfertas) {
...
function listener_vista_pedido(){
    ...
    btnMCGuardar.addEventListener('click',()=>{
        ...
        if(preciounitario==0 && !(pedido_aplica_ofertas() && pedido_es_medida_boni(Selected_codmedida))){
        ...
        if(!(pedido_aplica_ofertas() && pedido_es_medida_boni(Selected_codmedida)) && Number(preciounitario)<Number(Selected_costo)){
        ...
        .catch((err)=>{
            ...
            if (msg === 'sin_existencia' || msg.indexOf('BONI') >= 0 || msg.toLowerCase().indexOf('boni') >= 0 || msg.indexOf('oferta') >= 0) return;
    ...
    btnMCGuardarE.addEventListener('click',()=>{
        ...
        const esBoniOferta = pedido_aplica_ofertas() && pedido_es_medida_boni(Selected_codmedida);

        if(preciounitario==0 && !esBoniOferta){
            F.AvisoError('Precio inválido');
            return;
        };

        if(!esBoniOferta && Number(preciounitario)<Number(Selected_costo)){
            F.AvisoError('Precio menor al costo');
            return;
        };
        ...
        .catch((err)=>{
            const msg = String(err || '');
            if (msg.indexOf('BONI') >= 0 || msg.toLowerCase().indexOf('boni') >= 0 || msg.indexOf('oferta') >= 0) return;
            F.AvisoError('No se pudo agregar');
        })
                        ...
                        <div class="ped-cliente-card ${strClassVisitado}">
                            ...
                            <div class="ped-opciones-panel" id="${panelId}">
                                ...
                                <button type="button" class="btn btn-sm ped-opcion-btn btn-info hand" title="Mapa"
                                    ...
                                    <i class="fal fa-globe mr-1"></i>Mapa
                                </button>
                                <button type="button" class="btn btn-sm ped-opcion-btn ped-opcion-faltantes ped-opcion-faltantes--off hand" title="Faltantes mercaderista"
                                    data-codclie="${cod}"
                                    onclick="pedidos_ver_faltantes_ultima('${cod}','${nom}')">
                                    <i class="fal fa-box mr-1"></i>Faltantes
                                </button>
                                <button type="button" class="btn btn-sm ped-opcion-btn btn-primary hand" title="Goles"
                                ...
                                <button type="button" class="btn btn-sm ped-opcion-btn btn-secondary hand" title="Historial"
                                    onclick="get_historial_cliente('${cod}','${nom}','${tipo}','${neg}')">
                                    <i class="fal fa-book mr-1"></i>Historial
                                </button>
                                <button type="button" class="btn btn-sm ped-opcion-btn btn-success hand" title="Pedido"
...
function pedidos_bind_modales_detalle() {
    const $modals = $('.ped-modal-detalle');
    if (!$modals.length) return;
    $modals.off('show.bs.modal.pedBlur hidden.bs.modal.pedBlur');
    $modals.on('show.bs.modal.pedBlur', function () {
        document.body.classList.add('ped-modal-blur-open');
    });
    $modals.on('hidden.bs.modal.pedBlur', function () {
...
function pedidos_pintar_faltantes_mes() {
    const botones = document.querySelectorAll('#tblDataClientes .ped-opcion-faltantes');
    if (!botones.length) return;

    const mes = (typeof F.get_mes_curso === 'function') ? F.get_mes_curso() : (new Date().getMonth() + 1);
    const anio = (typeof F.get_anio_curso === 'function') ? F.get_anio_curso() : new Date().getFullYear();

    axios.post('/clientes/vendedor_faltantes_clientes_mes', {
        token: TOKEN,
        sucursal: GlobalEmpnit,
        codven: GlobalCodUsuario,
        mes,
    ...
    .then((res) => {
        ...
        const conFaltantes = new Set(rows.map((r) => String(r.CODCLIENTE)));
        botones.forEach((btn) => {
            const tiene = conFaltantes.has(String(btn.dataset.codclie || ''));
            btn.classList.toggle('ped-opcion-faltantes--on', tiene);
            btn.classList.toggle('ped-opcion-faltantes--off', !tiene);
        });
    })
    .catch(() => {});
}
...
function tbl_historial_cliente(){
    ...
    .then((data)=>{
        ...
        data.recordset.map((r)=>{
            str += `
            <tr>
                <td class="text-nowrap">${F.convertDateNormal(r.FECHA)}</td>
                <td>
                    <div class="negrita">${r.DESPROD || ''}</div>
                    <small class="text-muted">${r.CODPROD || ''}</small>
                </td>
                <td class="text-right">
                    <div class="negrita">${r.CANTIDAD}</div>
                    <small class="text-muted">${r.CODMEDIDA || ''}</small>
                </td>
                <td class="text-right negrita">${F.setMoneda(r.TOTALPRECIO,'Q')}</td>
            </tr>
            `
        })
        container.innerHTML = str; 
...
function get_marcas_cliente(codclie, nomclie){
    ...
    .then((data)=>{
        ...
        data.recordset.map((r)=>{
            ...
            str += `
                <tr class="${strClass}">
                    <td class="negrita">${r.DESMARCA || ''}</td>
                    <td class="text-right negrita">${F.setMoneda(r.TOTALPRECIO,'Q')}</td>
                </tr>
            `
        })
    ...
    .then((data)=>{
        ...
        data.recordset.map((r)=>{
          str+= `
            <tr>
                <td>
                    <div class="negrita">${F.limpiarTexto(r.DESPROD)}</div>
                    <small class="text-muted">${r.CODPROD || ''}</small>
                </td>
                <td class="text-right negrita">${r.TOTALUNIDADES}</td>
                <td class="text-right negrita">${F.setMoneda(r.TOTALPRECIO,'Q')}</td>
            </tr>
            ` 
        })
...
function pedido_aplica_ofertas(){
    return typeof aplica_ofertas_vendedores === 'function' && aplica_ofertas_vendedores() === true;
}

function pedido_es_medida_boni(codmedida){
    return String(codmedida || '').trim().toUpperCase() === 'BONI';
}
...
function pedido_precio_tipo(row){
    ...
    if (tipo === 'PRECIO_A') return Number(row.PRECIO_A) || 0;
    if (tipo === 'PRECIO_B') return Number(row.PRECIO_B) || 0;
    return Number(row.PRECIO) || 0;
}

function pedido_group_ofertas(rows){
    const map = {};
    (rows || []).forEach((r) => {
        ...
        if (!map[id]) {
            map[id] = {
                CODOFERTA: id,
                DESOFERTA: r.DESOFERTA || ('Oferta ' + id),
...
function pedido_cargar_ofertas_rows(){
    return axios.post(GlobalUrlCalls + '/ofertas/vendedor_disponibles', {
        token: TOKEN,
        sucursal: GlobalEmpnit
    }).then((res) => {
        if (!res.data || res.data.ok === false) throw new Error('ofertas');
        pedido_ofertas_rows = res.data.recordset || [];
        return pedido_ofertas_rows;
    });
}
...
function get_tbl_productos_clasificacion(codigo){
    ...
    .then((response) => {        
        if(response=='error'){
            ...
            const data = response.data.recordset;
            data.map((r)=>{
                if (pedido_aplica_ofertas() && pedido_es_medida_boni(r.CODMEDIDA)) return;
                str += `
...
function get_producto(codprod,desprod,codmedida,equivale,costo,precio,tipoprod,exento,existencia,bono){
            ...
            if (pedido_boni_ctx) {
                ...
                const maxUn = Number(pedido_boni_ctx.remaining) || 0;
                if (eq > maxUn + 0.0001) {
                    F.AvisoError('No hay cupo suficiente de BONI para esta medida');
                    pedido_boni_ctx = null;
            ...
            document.getElementById('txtMCCantidad').value = cantIni;
