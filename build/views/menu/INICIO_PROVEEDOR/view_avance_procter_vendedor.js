...
function addListeners(){
        ...
        const procter_loadEmpleados = (reloadReportes) => {
            GF.get_data_empleados_tipo_emp(300, proveedor_getSucursal())
            .then((data) => {
        ...
        procter_loadEmpleados(false);
        window.proveedor_embedRefresh = () => {
            procter_loadEmpleados(true);
        };
