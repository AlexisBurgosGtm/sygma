                            ...
                            <label class="modal-title text-base h3" id="">Buscar producto</label>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            class="form-control border-base negrita" placeholder='Escriba para buscar...' id="txtBuscarProd"
                                            oninput="F.crearBusquedaTabla('tblProductos','txtBuscarProd')">
                                        </div>
                                    </div>
    ...
    .then((response) => {        
        if(response=='error'){
            ...
            data.map((r)=>{
                ...
                str += `
                    <tr class="hand" 
                    onclick="get_producto('${r.CODPROD}','${r.DESPROD}','${r.DESPROD2}','${r.CODMEDIDA}','${r.EQUIVALE}','${r.COSTO}','${r.COSTO}','${r.TIPOPROD}','${r.EXENTO}','${r.EXISTENCIA}','${r.BONO}')">
                        <td>${r.DESMARCA}</td>
