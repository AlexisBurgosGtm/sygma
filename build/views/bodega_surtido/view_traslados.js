                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-base hand col-1 hidden" id="btnBuscarProd">
...
function listener_vista_pedido(){
    ...
    txtPosCodprod.addEventListener('keyup',(e)=>{
        ...
        F.FiltrarTabla('tblPedido','txtPosCodprod')
    ...
    let datos = 
        {
            ...
            USUARIO:'',
            CODPROD:F.limpiarTexto(codprod.toString()),
...
function finalizar_pedido(){
    ...
    get_tbl_pedido();
        ...
        //VERIFICACIONES
    if(Number(GlobalTotalItems)==0){F.AvisoError('No hay productos agregados');return;}
