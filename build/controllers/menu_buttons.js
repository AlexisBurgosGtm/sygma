        ...
        <ul id="js-nav-menu_digitador" class="nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" title="Layout Options" data-filter-tags="theme settings layout options"  onclick="Menu.report_ventas_vendedor()">
                                            <span class="nav-link-text" data-i18n="nav.theme_settings_layout_options">VENTAS VENDEDOR</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="Layout Options" data-filter-tags="theme settings layout options"  onclick="Menu.report_ventas_marcas()">
    ...
    inicio_supervisor: ()=>{
        return `
                        <ul id="js-nav-menu_supervisor" class="nav-menu">
                            ...
                            <li>
                                <a href="#" title="How it works" data-filter-tags="theme settings how it works"  onclick="Menu.report_ventas_vendedor()">
                                    <i class="fal fa-user"></i>
                                    <span class="nav-link-text" data-i18n="nav.theme_settings_how_it_works">VENTAS VENDEDOR</span>
                                </a>
                            </li>
                              <li>
                                <a href="#" title="How it works" data-filter-tags="theme settings how it works"  onclick="Menu.report_ventas_marcas()">
