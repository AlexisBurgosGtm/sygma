let GF = {
    ...
    update_ubicacion_empleado:(sucursal,codemp,lat,long)=>{
        ...
        return new Promise((resolve,reject)=>{
            ...
            axios.post(GlobalUrlCalls + '/empleados/empleados_login_ubicacion',
                            {
                                sucursal:sucursal,
                                token:TOKEN,
                                codemp:codemp,
    ...
    get_data_marcas_cliente: (sucursal,codclie,fecha)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/reportes/rpt_marcas_cliente_mes`, data)
            .then(res => {
    ...
    get_data_embarque_producto_facturas: (empnit, codembarque, codprod)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/despacho/pedidos_pendientes_embarque_producto_facturas`, data)
            .then(res => {
    ...
    get_data_embarque_productos_devueltos: (empnit,codembarque)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/despacho/pedidos_pendientes_embarque_productos_devueltos`, data)
            .then(res => {
    ...
    get_data_clientes_obj_skus_compra: (empnit,mi,mf,anio)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/clientes/update_obj_skus_compra`, data)
            .then(res => {
    ...
    get_data_inventarios_general_retroactivo_export: (sucursal,fecha,st)=>{
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/compras/select_inventario_general_retroactivo_export`, data)
            .then(res => {
    ...
    get_data_empleados_localizacion: (empnit)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/empleados/empleados_localizacion`, data)
            .then(res => {
    ...
    get_data_objetivo_cliente_mes: (sucursal,codclie,mes,anio)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/clientes/objetivo_cliente_mes`, data)
            .then(res => {
    ...
    get_data_universo_clientes_empleado_visitado_mes: (sucursal,codemp,mes,anio)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/objetivos/universo_clientes_empleado_visitado_mes`, data)
            .then(res => {
    ...
    data_cobertura_goles_marcas_empleado: (sucursal,mes,anio,codemp)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/objetivos/cobertura_marcas_goles_empleado`, data)
            .then(res => {
    ...
    get_data_logro_procter_skus_tienda:(sucursal,codemp,mes,anio)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            axios.post(`/objetivos/select_objetivo_skus_tienda`, data)
            .then(res => {
    ...
    data_vehiculos_todos(){
    
  
        return new Promise((resolve,reject)=>{
    
            axios.post(GlobalUrlCalls + '/vehiculos/listado_vehiculos_todos',
                {
                    token:TOKEN
                })
            .then((response) => {
    ...
    data_vehiculos(sucursal){
    
  
        return new Promise((resolve,reject)=>{
    
            axios.post(GlobalUrlCalls + '/vehiculos/listado_vehiculos',
                {
                    token:TOKEN,
                    sucursal:sucursal
                })
    ...
    delete_vehiculo(codvehiculo){
    
  
        return new Promise((resolve,reject)=>{
    
            axios.post(GlobalUrlCalls + '/vehiculos/delete_vehiculo',
                {
                    token:TOKEN,
    ...
    insert_vehiculo(sucursal,desvehiculo,placa,chasis,motor,kms_inicial,kms_actual,kms_fecha,ultimo_servicio){
    
  
        return new Promise((resolve,reject)=>{
    
            axios.post(GlobalUrlCalls + '/vehiculos/insert_vehiculo',
                {
                    token:TOKEN,
                    sucursal:sucursal,
                    desvehiculo:desvehiculo,
                    placa:placa,
                    chasis:chasis,
                    motor:motor,
                    kms_inicial:kms_inicial,
                    kms_actual:kms_actual,
                    kms_fecha:kms_fecha,
