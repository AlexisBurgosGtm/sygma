...
let db_checkin = {
    verify:(codemp,fecha)=>{
        ...
        console.log('verificando checkin para codemp: ' + codemp.toString() + ' fecha: ' + fecha.toString())
        return new Promise(async(resolve,reject)=>{
            var response = await connection.select({
                from: "checkin",
                where: {
    ...
    finalizar:(codemp,fecha)=>{
        
        console.log('finalizando checkin para codemp: ' + codemp.toString() + ' fecha: ' + fecha.toString())
        ...
        return new Promise(async(resolve,reject)=>{
            ...
            try { 
                ...
                console.log('Error finalizando checkin:', error);
                reject();
            }
    ...
    delete:()=>{
        return new Promise(async(resolve,reject)=>{
            var rowsDeleted = await connection.clear("checkin");
            resolve();
        })            
    }
};
