...
ALTER TABLE DOCUMENTOS ADD CODEMBARQUE VARCHAR(300) NULL;
ALTER TABLE DOCUMENTOS_TEMPORALES ADD CODEMBARQUE VARCHAR(300) NULL;


ALTER TABLE EMPLEADOS ADD CODDOC_ENV VARCHAR(50) NULL;
ALTER TABLE EMPLEADOS ADD CODDOC_COT VARCHAR(50) NULL;
